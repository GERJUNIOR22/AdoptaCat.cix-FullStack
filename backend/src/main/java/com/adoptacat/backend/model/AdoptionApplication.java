...
public class AdoptionApplication {
    ...
    public LivingType getLivingType() { return livingType; }
    public void setLivingType(LivingType livingType) { this.livingType = livingType; }
    ...
    public String getWhoPayExpenses() { return whoPayExpenses; }
    public void setWhoPayExpenses(String whoPayExpenses) { this.whoPayExpenses = whoPayExpenses; }
