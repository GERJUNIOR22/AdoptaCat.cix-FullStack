        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div class="space-y-4">
            ...
            <div class="mt-6 p-4 bg-rose-600 bg-opacity-50 rounded-lg border border-rose-400 border-opacity-30">
              <p class="text-white text-xs mb-2 font-medium">Síguenos en redes sociales:</p>
        ...
        <div class="border-t border-rose-400 border-opacity-30 mt-12 pt-8">
          <div class="flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="flex items-center gap-6 mt-4 md:mt-0">
              <span class="text-rose-200 text-sm hover:text-white cursor-pointer transition-colors">Política de Privacidad</span>
              <span class="text-rose-200 text-sm hover:text-white cursor-pointer transition-colors">Términos de Uso</span>
            </div>
          </div>
        </div>
      </div>
